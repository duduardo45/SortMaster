import os
import sys
from detect_and_classify.integration import take_photo_command_arduino # Substitua 'sua_funcao' pela função correta
...
def form(box_id):
    if request.method == 'POST':
        ...
        document = {'name': name, 'box_id': box_id, 'mode': mode, 'position_x': position_x, 'position_y': position_y}
    ...
    print(f'Box ID: {box_id}, Existing Data: {existing_data}')  # Adicione esta linha para ajudar na depuração
